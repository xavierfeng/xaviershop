...
// 在键盘按下并释放及提交后验证提交表单
            ...
            $('#cmbProvince').bind('change',function () {
                $(this).find('option[value=<?=$address->province?>]').prop('selected',true);
            });
            $('#cmbProvince').trigger('change');

            $('#cmbCity').bind('change',function () {
                $(this).find('option[value=<?=$address->city?>]').prop('selected',true);
            });
            $('#cmbCity').trigger('change');

            $('#cmbArea').bind('change',function () {
                $(this).find('option[value=<?=$address->county?>]').prop('selected',true);
            });
