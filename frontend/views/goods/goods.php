...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a> > <a href="<?=\yii\helpers\Url::to(['goods/list','id'=>$goods->category->parent->id])?>"><?=$goods->category->parent->name?></a> > <a href="<?=\yii\helpers\Url::to(['goods/list','id'=>$goods->category->id])?>"><?=$goods->category->name?></a> > <?=$goods->name?></h2>
		</div>
		<!-- 面包屑导航 end -->
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goods->logo?>" alt="" style="width:350px;height:350px;" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
