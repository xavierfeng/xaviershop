...
<body>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="<?=\yii\helpers\Url::to(['member/index'])?>">首页</a> > <a href="<?=\yii\helpers\Url::to(['goods/list','id'=>$goods_category->id])?>"><?=$goods_category->name?></a></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(['goods/goods','id'=>$goods->id])?>"><img src="<?=$goods->logo?>" alt="" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['goods/goods','id'=>$goods->id])?>"><?=$goods->name?></a></dt>
							<dd><strong>￥<?=$goods->shop_price?></strong></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['goods/goods','id'=>$goods->id])?>"><em>已有998人评价</em></a></dt>
						</dl>
					</li>
                    <?php endforeach; ?>
				</ul>
